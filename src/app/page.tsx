...
import { useDashboard } from '@/components/features/layout/DashboardContext';
...
import { AnnouncementBanner } from '@/components/features/layout/AnnouncementBanner';
import { MOCK_PROMPTS, PromptItem } from '@/components/features/promptsData';
...
function HomeContent() {
  ...
  const renderContent = () => {
    // If a prompt card is selected, show detail view
    if (selectedPromptId) {
    ...
    return (
      <div className="flex-grow flex flex-col">
        ...
        {showBanner && currentView === 'browse' && !selectedPromptId && (
        ...
        <PromptGrid prompts={filteredPrompts} onCardClick={setSelectedPromptId} />
      </div>
    );
  };
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Header (contains title, search, and category pills) */}
      {!selectedPromptId && <Header />}
